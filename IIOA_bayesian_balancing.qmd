...
-   need for **balancing** (reconciliation) to satisfy key accounting and consistency constraints: supply = demand, input = output
...
## Thank you {.center-title .smaller .wrap-links}
...
👈 Slides: <https://simschul.github.io/2026_IIOA_conference_Sevilla/>
